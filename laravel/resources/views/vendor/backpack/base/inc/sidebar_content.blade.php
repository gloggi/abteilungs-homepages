...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('settings') }}'><i class='nav-icon fa fa-cog'></i> @lang('settings')</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('section') }}'><i class='nav-icon fa fa-sitemap'></i> @lang('sections')</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('group') }}'><i class='nav-icon fa fa-users'></i> @lang('groups')</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('staff-contact') }}'><i class='nav-icon fa fa-id-card'></i> @lang('staff_contacts')</a></li>
